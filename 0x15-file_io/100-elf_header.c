...
/**
 * _close - close a file descriptor and print an error message on failure
 ...
 * @count: the number of bytes to read from
 */
...
/**
 * elf_version - printf ELF version
 * @buffer: the ELF header
 */
...
/**
 * main - copy a file's contents to anotehr file
